...
function linear_regression($x, $y)
{
    ...
    $sumx = array_sum($x);
    $sumy = array_sum($y);
    $sumxx = array_sum( array_map("mult_arrays", $x, $x) );
    //$sumyy = array_sum( array_map("mult_arrays", $y, $y) );
    $sumxy = array_sum( array_map("mult_arrays", $x, $y) );
    $Sxx = $sumxx - $sumx*$sumx/$n;
    //$Syy = $sumyy - $sumy*$sumy/$n;
    $Sxy = $sumxy - $sumx*$sumy/$n;
    
    $slope = $Sxy/$Sxx;
    $y_intercept = ($sumy - $slope*$sumx)/(1.0*$n);
