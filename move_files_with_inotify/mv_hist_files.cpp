...
public:
  ...
  /*default constructor*/
  inotify_processing(){max_size=6;drpc="DRPC_MM_DR_";fepc1="FEPC1_MM_FE_";fepc2="FEPC2_MM_FE_";fepc3="FEPC3_MM_FE_";fepc4="FEPC4_MM_FE_";drpc_min=0;fepc1_min=0;fepc2_min=0;fepc3_min=0;fepc4_min=0;}
  ...
  void notify()
  {
	...
	i += (sizeof(struct inotify_event)+safe)+(event->len);
      }
    close(wd);
    close(fd);
    free(ptr);
